      ...
      <div className="container ">
        ...
        <div className="leave-details-container">
          ...
          <div className="row dark-border ">
            ...
            <div className="col col-padding dark-border border-top-0 border-bottom-0 border-right-0">
              <h3 className='key text-center'>Position</h3>
            </div>
            ...
            <div className="col col-padding  border-top-0 dark-border border-bottom-0 border-right-0">
              <h3 className='key text-center'>Resume Date</h3>
            </div>
            <div className="col col-padding  border-top-0 dark-border border-bottom-0 border-right-0">
              <h3 className='key text-center'> Last working Dates</h3>
            </div>
            <div className="col col-padding  border-top-0 dark-border border-bottom-0 border-right-0">
              <h3 className='key text-center'> Exit Type</h3>
            </div>
          ...
          {Array.isArray(formData) && formData.length > 0 && formData.map((item, index) => (
            <div className="leave-entry" key={index}>
              <div className="row dark-border border-top-0 border-right-0">
                <div className="col col-padding">
                  <h3 className='key text-center'><span className='value'>{item?.employeeId?.name}</span></h3>
                </div>
                <div className="col col-padding dark-border border-top-0  border-bottom-0">
                  <h3 className='key text-center'> <span className='value'>{item?.employeeId?.arabicName}</span></h3>
                </div>
                
                <div className="col col-padding dark-border border-right-0 border-left-0 border-top-0 border-bottom-0">
                ...
                <div className="col col-padding dark-border  border-top-0 border-bottom-0">
                  <h3 className='key text-center'> <span className='value'>
                    {item?.dateOfJoining?moment.parseZone(item?.employeeId?.dateOfJoining).local().format("DD/MM/YYYY"):""}
                  </span></h3>
                </div>
                <div className="col col-padding dark-border border-left-0 border-top-0 border-bottom-0">
                  <h3 className='key text-center'> <span className='value'>
                    {item?.resumingofLastVacation?moment.parseZone(item?.resumingofLastVacation).local().format("DD/MM/YYYY"):""}
                  </span></h3>
                </div>
                <div className="col col-padding dark-border border-left-0 border-top-0 border-bottom-0">
                  <h3 className='key text-center'> <span className='value'>
                    {item?.lastWorkingDate?moment.parseZone(item?.lastWorkingDate).local().format("DD/MM/YYYY"):""}
                  </span></h3>
                </div>
                <div className="col col-padding dark-border border-left-0 border-top-0 border-bottom-0">
                  <h3 className='key text-center'> <span className='value'>
...
export default LeftEmployeePdf
